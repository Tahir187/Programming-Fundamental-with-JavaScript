...
let R = prompt("Enter the length of the row in feet: ");
let E = prompt("Enter the amount of space used by an end-post assembly, in feet: ");
let S = prompt("Enter the amount of space between the vines, in feet: ");
let V = (R- (2*E) )/S

console.log("The number of grapevines that will fit in the row are: ",V)