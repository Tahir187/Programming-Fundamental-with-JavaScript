...
let rate = prompt("Enter the intreset rate as a percentage: ");

let n = prompt(
  "Enter the number of times per year that the interest is compounded (For example, if interest is compounded monthly, enter 12. If interest is compounded quarterly, enter 4.: "
);

let t = prompt(
  "Enter the number of years the account will be left to earn interest: "
);

let A = (P * (1 + rate / n)) ^ (n * t);
console.log("The amount of money will be: ", A);
